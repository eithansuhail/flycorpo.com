...
<
    ...
    // } else { echo 'File is not valid. Please try again'; }
         ...
         $query = "INSERT INTO `holidaypkgs` ( `name`,`coupon_code`, `deadline`, `image`,`price`,`desc`,`location`) VALUES ('$name', '$coupon_code', '$deadline','$passport_front','$price','$desc','$location')"; 
      ...
      ?>
        ...
        <div class="container section-content"  >
           <h3 class="text-center">Upload Holiday Package</h3>
          

               <form method="post" action="<?php $_PHP_SELF ?>" enctype="multipart/form-data">
                 
                  <div class="row col-md-12"> 
        <div class="form-group col-md-3 col-xs-6 form-group-lg">
           <label>Name </label>
                    <input type="text" class="form-control " placeholder="Name" name='name'  required autofocus/>
                    </div>
        <div class="form-group col-md-3 col-xs-6 form-group-lg">
           <label>coupon_code</label>
                    <input type="text" class="form-control email-box" placeholder="coupon_code" name='coupon_code'  maxlength="20" required autofocus/>
                    </div>
                      <div class="form-group col-md-3 col-xs-6 form-group-lg">
           <label>Price</label>
                    <input type="text" class="form-control email-box" placeholder="Price" name='price'  required autofocus/>
                    </div>

                 
        <div class="form-group col-md-3 col-xs-6 form-group-lg">
           <label>Description</label>
                    <input type="text" class="form-control email-box" placeholder="Description" name='desc'  required autofocus/>
                    </div>
                    </div>
           ...
           <div class="form-group col-md-4 col-xs-6 form-group-lg">
           <label>Location</label>
                    <input type="text" class="form-control email-box" placeholder="Location" name='location'  required autofocus/>
                    </div>
        ...
        <div class="form-group col-md-4 form-group-lg">
           <label>image</label>
                    <input type="file"  class="form-control " placeholder="Passport Front" name='front'   autofocus/>
                    </div>
