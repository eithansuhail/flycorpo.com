...
<body style="display: none;">
	<form method="POST" name="customerData" action="ccvanue/ccavRequestHandler.php">
    <table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
      <table width="50%" height="100" border='1' align="center">
        ...
        <tr>
          <td>Merchant Id :</td><td><input type="text" name="merchant_id" value="215364"/></td>
        </tr>
        <tr>
          <td>Order Id  :</td><td><input type="text" name="order_id" value="<?php echo $tid; ?>"/></td>
        </tr>
        <tr>
          <td>Amount  :</td><td><input type="text" name="amount" value="<?php echo $TotalFare ;?>"/></td>
        </tr>
        <tr>
          <td>Currency  :</td><td><input type="text" name="currency" value="INR"/></td>
        </tr>
        <tr>
          <td>Redirect URL  :</td><td><input type="text" name="redirect_url" value="http://ariham.in/mmt/booking/ccavResponseHandler.php"/></td>
        </tr>
        <tr>
          <td>Cancel URL  :</td><td><input type="text" name="cancel_url" value="http://ariham.in/mmt/booking/ccavResponseHandler.php"/></td>
        </tr>
        <tr>
