...
<head>
    <title>Credit Card Ticket Order Form - Flycorpo Travels LLP</title>
    <meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    <meta name="keywords" content="Flycorpo" />
    <meta name="description" content="Flycorpo's Credit Card Ticket Order Form">
...
<body onload="active_nav()">
    ...
    <div class="head-block">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
        <h4><span style="color:#d6171f;">Credit Card Ticket Order Form</span></h4>
     ...
     if(isset($_POST['submit']))
      {
          ...
          if (($_POST['firstname2']) != ''){
            if ($_POST['firstname2'] ==''  ||  $_POST['lastname2'] =='' ||   $_POST['dob2']  =='' || $_POST['gender2' ==''] ) {
                  echo "All fields are required for passenger 2.</p>";
            }
          }

            else if (($_POST['firstname3']) != ''){
            if ($_POST['firstname3'] ==''  ||  $_POST['lastname3'] =='' ||   $_POST['dob3']  =='' || $_POST['gender3' ==''] ) {
                  echo "All fields are required for passenger 3.</p>";
            }
          }
            else if (($_POST['firstname4']) != ''){
            if ($_POST['firstname4'] ==''  ||  $_POST['lastname4'] =='' ||   $_POST['dob4']  =='' || $_POST['gender4' ==''] ) {
          ...
          // }
              ...
              echo "<p>Amount is required.</p>";
                 ...
                 $query = "INSERT INTO credit_info(pnr, airlineid, email, card_name, mobile, card_number,cvv,bil_ad,city,state,zipcode,tollfree,bankname,amount) 
                 VALUES ('".$_POST['pnr']."','". 
                 $_POST['airlineid']."','". $_POST['email']."','". $_POST['card_name']."','". $_POST['mobile']."','". $_POST['card_number']."','". $_POST['cvv']."','". $_POST['bil_ad']."','". $_POST['city']."','". $_POST['state']."','". $_POST['zipcode']."','". $_POST['tollfree']."','". $_POST['bankname']."','". $_POST['amount']."')"; 
                 ...
                 // echo $query;
                  ...
                  if (mysqli_query($link,$query)) {
                      ...
                      // echo  $lastid;
                       ...
                       $query = "INSERT INTO credit_table(cc_id, firstname, lastname, dob, gender) 
                              VALUES ('$lastid','".$_POST['firstname1']."','". 
                                 $_POST['lastname1']."','". $_POST['dob1']."','". $_POST['gender1']."')";
                             ...
                             $query = "INSERT INTO credit_table(cc_id, firstname, lastname, dob, gender) 
                              VALUES ('$lastid','".$_POST['firstname2']."','". 
                                 $_POST['lastname2']."','". $_POST['dob2']."','". $_POST['gender2']."')";
                      ...
                      if (($_POST['firstname3']) != ''){
                             $query = "INSERT INTO credit_table(cc_id, firstname, lastname, dob, gender) 
                              VALUES ('$lastid','".$_POST['firstname3']."','". 
                                 $_POST['lastname3']."','". $_POST['dob3']."','". $_POST['gender3']."')";
                             ...
                             $query = "INSERT INTO credit_table(cc_id, firstname, lastname, dob, gender) 
                              VALUES ('$lastid','".$_POST['firstname4']."','". 
                                 $_POST['lastname4']."','". $_POST['dob4']."','". $_POST['gender4']."')";
                         ...
                         if (($_POST['firstname5']) != ''){
                             $query = "INSERT INTO credit_table(cc_id, firstname, lastname, dob, gender) 
                              VALUES ('$lastid','".$_POST['firstname5']."','". 
                                 $_POST['lastname5']."','". $_POST['dob5']."','". $_POST['gender5']."')";
                    ...
                    if($condition==11)
{
    ...
    <section class="container">
        ...
        <div class="container section-content"  >
           ...
           <h3 class="text-center" style="font-weight: bold;">Credit Card Ticket Order Form</h3>
        ...
        <div class="form-group col-md-3 form-group-lg">
           <label>First Name </label>
                    <input type="text" class="form-control " pattern="[A-Za-z ]+" placeholder="First Name" name='firstname1' minlength="3" maxlength="20" required   autofocus/>
                    </div>
            <div class="form-group col-md-3 form-group-lg">
         ...
         <div class="form-group col-md-3 form-group-lg ">
              <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-highlight"></i>
                  <label>DOB</label>
                   ...
                   <input class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name='dob1' />
              </div>
          </div>
          <div class="form-group col-md-3 form-group-lg">
           <label>Gender</label>
        ...
        <div class="form-group col-md-3 form-group-lg">
           <label>First Name </label>
                    <input type="text" class="form-control " pattern="[A-Za-z ]+" placeholder="First Name" name='firstname2' minlength="3" maxlength="20"    autofocus/>
                    </div>
            <div class="form-group col-md-3 form-group-lg">
           <label>Last Name </label>
         ...
         <div class="form-group col-md-3 form-group-lg ">
              <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-highlight"></i>
                  <label>DOB</label>
                   ...
                   <input class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name='dob2' />
              </div>
          </div>
          <div class="form-group col-md-3 form-group-lg">
           <label>Gender</label>
        ...
        <div class="form-group col-md-3 form-group-lg">
           <label>First Name </label>
                    <input type="text" class="form-control " pattern="[A-Za-z ]+" placeholder="First Name" name='firstname3' minlength="3" maxlength="20"    autofocus/>
                    </div>
            <div class="form-group col-md-3 form-group-lg">
           <label>Last Name </label>
         ...
         <div class="form-group col-md-3 form-group-lg ">
              <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-highlight"></i>
                  <label>DOB</label>
                   ...
                   <input class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name='dob3' />
              </div>
          </div>
          <div class="form-group col-md-3 form-group-lg">
           <label>Gender</label>
        ...
        <div class="form-group col-md-3 form-group-lg">
           <label>First Name </label>
                    <input type="text" class="form-control " pattern="[A-Za-z ]+" placeholder="First Name" name='firstname4' minlength="3" maxlength="20"    autofocus/>
                    </div>
            <div class="form-group col-md-3 form-group-lg">
           <label>Last Name </label>
         ...
         <div class="form-group col-md-3 form-group-lg ">
              <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-highlight"></i>
                  <label>DOB</label>
                   ...
                   <input class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name='dob4' />
              </div>
          </div>
          <div class="form-group col-md-3 form-group-lg">
           <label>Gender</label>
            <select class="form-control" name='gender4'>
              <option value="">Select</option>
              <option value="male">Male</option>
              <option value="female">Female</option>
            </select>
        ...
        <div class="form-group col-md-3 form-group-lg">
           <label>First Name </label>
                    <input type="text" class="form-control " pattern="[A-Za-z ]+" placeholder="First Name" name='firstname5' minlength="3" maxlength="20"    autofocus/>
                    </div>
            <div class="form-group col-md-3 form-group-lg">
           <label>Last Name </label>
         ...
         <div class="form-group col-md-3 form-group-lg ">
              <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-highlight"></i>
                  <label>DOB</label>
                   ...
                   <input class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name='dob5' />
              </div>
          </div>
          <div class="form-group col-md-3 form-group-lg">
           <label>Gender</label>
            <select class="form-control" name='gender5'>
              <option value="">Select</option>
              <option value="male">Male</option>
              <option value="female">Female</option>
            </select>
