    ...
    if (mysqli_query($link, $query)) {
     ...
     if(isset($_POST['submit']) &&  isset($_POST['update'])){
      ...
      $query = "UPDATE  deals set name = '$name',coupon_code = '$coupon_code',deadline = '$deadline' WHERE id='$id'";
  ...
  if($_FILES['front']['error'] > 0) { echo 'Error during uploading, try again'; }
    ...
    // } else { echo 'File is not valid. Please try again'; }
        ...
        $sql = "UPDATE  deals set image = 'passport_front' WHERE id='$id'";
          ...
          <section class="section-content  popular-cities-blk popular-holyday-spots" style="padding-top: 40px;background-color:#151b35; " >
              <div class="container ">
                <div class="popular-bg-block holyday-spots">
                 ...
                 <h2 class="text-center" style="color: white;"> All Deals</h2>
    ...
    <th class="col-md-1 col-sm-4 col-xs-4 text-center padding-0"> name</th> 
    <th class="col-md-4 col-sm-4 col-xs-4 text-center padding-0"> image</th>
    <th class="col-md-2 col-sm-4 col-xs-4 text-center padding-0"> coupon_code</th> 
    <th class="col-md-2 col-sm-4 col-xs-4 text-center padding-0"> deadline</th> 
                ...
                <td class="col-md-1 col-sm-4 col-xs-4 text-center padding-0"> <?php echo $row["id"] ?></td>
                            <td class="col-md-1 col-sm-4 col-xs-4 text-center padding-0"><input type="text" name="name" value=" <?php echo $row["name"] ?>"></td>
                            <td class="col-md-4 col-sm-4 col-xs-4 text-center padding-0"><input readonly="readonly" type="text" name="image" value=" <?php echo $row["image"] ?>"> </td>
                <td class="col-md-2 col-sm-4 col-xs-4 text-center padding-0"><input type="text" name="coupon_code" value=" <?php echo $row["coupon_code"] ?>"> </td>
