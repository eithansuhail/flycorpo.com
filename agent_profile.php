...
<body onload="active_nav()">
    ...
    <div class="global-wrap">
        ...
        <div class="bg-holder">
          ...
          <h2 class="text-center">Agent Profile</h2>
   <div class="container " style=" box-shadow: 2px 2px 2px 2px #8888; border-radius: 10px; margin-bottom: 30px;">
				...
				<div class="w3-section text-muted" style="float: right; margin: 10px;">
					  ...
					  <!--     <form action="<?php $_PHP_SELF ?>" method="post" enctype="multipart/form-data">
					      ...
					      <p > <strong style="text-transform: uppercase;"><?php echo $_SESSION['agent_name']; ?></strong> <span class="text-muted" style="font-size: 12px;"><?php echo $_SESSION['agent_email']; ?></span></p>
	...
	<div class="booking-item-container container">
		<div class="text-center"><h3>Booked Flights</h3></div>
                                  ...
                                  <div  class="booking-item">
                                    <div>
                                        <div class="list-header col-md-9">
                                            ...
                                            <!-- <div class="col-md-2 text-center p-r-0">Mobile</div> -->
                                       ...
                                       <ul class="list-inline list-unstyled flight-search-ul">
                                           ...
                                           $email = $_SESSION['agent_email'];
                                            ...
                                            $query = "SELECT ReferenceNo,GDFPNRNo,EticketNo, TransactionId, IntAmount, IntBaseFare FROM bookedflight where booker_email = '$email' && usertype= 'agent'";
                    ...
                    if (mysqli_num_rows($result) == 0){
                       echo "<div class='text-suceess text-center'><h4>Please book a flight to see details here.</h4></div>";
