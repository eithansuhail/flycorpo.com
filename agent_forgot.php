...
<html>
  <head>
    <title>Forgot your agent Password - Flycorpo Travels LLP</title>
    <meta content="text/html;charset=utf-8" http-equiv="Content-Type" />
    <meta name="keywords" content="Flycorpo" />
    <meta name="description" content="Forgot your password? Please provide the username or email address that you used when you signed up for your Flycorpo account." />
  ...
  <body>
    ...
    <div class="global-wrap">
      ...
      if(isset($_POST['submit']) && isset($_POST['form2']))
      {
          
          $email = $_POST['agent_email']; 
          $name = $_POST['agent_name'];
          $pass1 = $_POST['agent_pass1'];
          $pass2 = $_POST['agent_pass2'];
          ...
          } else if ($_POST['agent_pass1'] == '' || $_POST['agent_pass2'] == '') {
          ...
          //   
              ...
              $query1 = "SELECT 'agent_email' FROM `agent` WHERE agent_email = '$email' and agent_name='$name'";
         ...
         if(mysqli_num_rows($result) > 0){
            $query = "UPDATE 
            `agent` set agent_password ='$pass1' where agent_email='$email'"; 
                  ...
                  if (mysqli_query($link,$query)) {
                      ...
                      echo "Error updating record not matched: " . $link->error;
                      // echo "<p>There was a problem in Forgetting password - please try again later.</p>";
        ...
        <div class="container">
          <div class="row">
              ...
              <div class="col-md-4">
                ...
                /*opacity: 0.5;*/
                border: 2px;">
          <h2 style="">Agent Forgot Password</h2>
                ...
                <div class="subscription-blk">
                  <form method="post" class="m-x-auto text-center app-login-form" role="form" action="<?php $_PHP_SELF ?>">
                    <div class="form-group form-group-lg">
                       <input type="hidden" name="form2" value="agent">
                      <input type="text" class="form-control email-box" placeholder="Name" name='agent_name' maxlength="30" minlength="5"  required autofocus />
                    </div>
                    <div class="form-group form-group-lg">
                      <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control email-box" placeholder="Email ID/Mobile" name='agent_email' required  autofocus/>
                    </div>
                    <div class="form-group form-group-lg">
                      <input type="password" class="form-control email-box" placeholder="New Password" name='agent_pass1' minlength="6" maxlength="20" required autocomplete="off" autofocus/>
                    </div>
                    <div class="form-group form-group-lg">
                      <input type="password" class="form-control email-box" placeholder="New Confirm Password" name='agent_pass2'minlength="6" maxlength="20" required autocomplete="off" autofocus/>
                    </div>
                    <div class="text-center"><button type="submit" name='submit' class="btn btn-primary">Submit</button></div>
                  </form><br>
                 <p style="font-size: 14px;"> If Know your Password. <a href="agent_login.php" style="font-weight: bold;">Login Here!</a></p>
                </div>
              </div>
            </div>
          </div>
