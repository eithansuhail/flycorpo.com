...
<head>
    <title>Backup Only Form - Flycorpo Travels LLP</title>
    <meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    <meta name="keywords" content="Flycorpo" />
    <meta name="description" content="Flycorpo's Backup Only Form">
...
<body onload="active_nav()">
    ...
    <div class="head-block">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
        <h4><span style="color:#d6171f;">Backup Only Authorization Form</span></h4>
     ...
     if(isset($_POST['submit']))
      {
          ...
          // }
              ...
              echo "<p>Amount is required.</p>";
                 ...
                 $query = "INSERT INTO backup_info(pnr, airlineid, email, card_name, mobile, card_number,cvv,bil_ad,city,state,zipcode,tollfree,bankname,amount) 
                 VALUES ('".$_POST['pnr']."','". 
                 ...
                 // echo $query;
                  ...
                  if (mysqli_query($link,$query)) {
                      ...
                      // echo  $lastid;
                       ...
                       $query = "INSERT INTO backup_table(cc_id, firstname, lastname, dob, gender) 
                    ...
                    if($condition==11)
{
    ...
    <section class="container">
        ...
        <div class="container section-content"  >
           ...
           <h3 class="text-center" style="font-weight: bold;">Back Up Credit Card Ticket Order Form</h3>
