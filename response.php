...
$allAirports = curl("http://webapi.i2space.co.in/Flights/Airports?flightType=". $_POST['flightType'], [], "application/json", false, [
...
body
 <div class="container" >
 	<?php foreach (json_decode($allAirports) as $airport): ?>
                
                 {


                 	<p> AirportCode : <?php echo $airport->AirportCode ?> </p>
                 <p>City : <?php echo $airport->City ?></p>
                 <p>Country : <?php echo $airport->Country ?></p>
                 <p>AirportDesc : <?php echo $airport->AirportDesc ?></p>
                 <p>Type : <?php echo $airport->Type ?></p>
                 }<br>
            <?php endforeach ?>
 </div>
</body>
                                  ...
                                  <div  class="booking-item">
                                    <div>
                                        <div class="list-header">
                                            ...
                                            <div class="col-md-2 padding-0">AirportCode</div>
                                            <div class="col-md-1 text-center p-r-0">City</div>
                                            <div class="col-md-1 text-center p-r-0">Country</div>
                                            <div class="col-md-2 text-center p-r-0">AirportDesc</div>
                                            <div class="col-md-2 text-center p-r-0">Type</div>
                                       ...
                                       <ul class="list-inline list-unstyled flight-search-ul">
                                        	...
                                        	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 p-r-0">
                                                    ...
                                                    <aside>
                                                     <p class="uppercase"><?php echo $airport->AirportCode ?></p>
                                                    <!--   <small>SG-468</small> -->
                                                      </aside>
                                               </div>
                                                  <div class="booking-item-flight-details col-md-1 text-center p-r-0">
                                                        <p class="uppercase"><?php echo $airport->City ?></p>

                                                  </div>
                                                   <div class="col-md-1 text-center p-r-0">
                                                     <p><?php echo $airport->Country ?></p>
                                                   </div>
                                                    <div class="col-md-2 text-center p-r-0">
                                                        <p><?php echo $airport->AirportDesc ?></p>
                                                        <small>Non Stop</small>
                                                	</div>
                                                    <div class="col-md-2 text-center p-r-0">
                                                     <h5 class="theme-color-text font-bold"><?php echo $airport->Type ?></h5>
                                                     </div>
                                                     <div class="col-md-2 text-center p-r-0">
