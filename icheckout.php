...
$url = "https://webapi.etravos.com/Flights/AvailableFlights?source=".$_SESSION['from_address']."&destination=".$_SESSION['to_address']."&journeyDate=".$_SESSION['start_Date']."&tripType=".$_SESSION['tripType']."&flightType=2&adults=".$_SESSION['Adults']."&children=".$_SESSION['Children']."&infants=".$_SESSION['Infant']."&travelClass=".$_SESSION['classvalue']."&userType=5&returnDate=".$_SESSION['endDate'];
// echo $url;
                                        	...
                                        	<div class="secure-block">
                                               ...
                                               <!--  <div class=" m-t-30">
                                                ...
                                                <div class="traveller-details">
                                                    ...
                                                    <form method="GET" class="m-t-15 p-lr-7" action="ipaymentconfirmation.php">
                                                  <!--   <div class="row">
                                                    ...
                                                    <p >Adults 1</p>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-xs-2 col padding-0">
                                                                
                                                                        <label>Title</label>
                                                            <select class="form-control padding-2"name="title<?php echo 1; ?>">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-xs-6">
                                                                        <label>State</label>
                                                           <select  name="state"  class="form-control state" id="state"><option value="" >Select</option>
                                                                            <?php echo $states;  ?>
                                                          ...
                                                          <div class="row"> 
                                                            ...
                                                            <select class="form-control"name="avisatype<?php echo 1; ?>">
                                                          ...
                                                          <div class="col-lg-2 col-md-2 col-xs-4">
                                                            ...
                                                            <input required type="text" class="form-control" placeholder="Passport No" name="apassportno<?php echo 1; ?>"></div>
                                                            <div class="col-lg-2 col-md-2 col-xs-5">
                                                                        <label>Issue place</label>
                                                            <input required type="text" class="form-control" placeholder="Issue place" name="aissueplace<?php echo 1; ?>"></div>
                                                         ...
                                                         <div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                ...
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="aissuedate<?php echo 1; ?>" />
                                                             </div>
                                                        </div><div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                        <label>Expiry date</label>
                                                                <i class="fa fa-calendar input-icon input-icon-highlight"></i>
                                                                        
                                                                            
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="aexpirydate<?php echo 1; ?>" />
                                                             </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-2 name  col-md-2 col-xs-6">
                                                                        <label>First Name</label>
                                                        ...
                                                        <div class="col-lg-2 age col-md-2 col-xs-3">
                                                                        <label>Age</label>
                                                            <input required maxlength="2" type="text" class="form-control" placeholder="Age" name="age<?php echo $i+1; ?>"></div>
                                                          ...
                                                          <div class="row"> 
                                                                <div class="col-lg-2 col-md-2 col-xs-2 padding-0">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>Visa Type</label>
                                                            <select class="form-control"name="avisatype<?php echo $i+1; ?>">
                                                          ...
                                                          <div class="col-lg-2 col-md-2 col-xs-5 ">
                                                                        <label>Passport No</label>
                                                            <input required type="text" class="form-control" placeholder="Passport No" name="apassportno<?php echo $i+1; ?>"></div>
                                                            <div class="col-lg-2 col-md-2 col-xs-5">
                                                                        <label>Issue place</label>
                                                            <input required type="text" class="form-control" placeholder="Issue place" name="aissueplace<?php echo $i+1; ?>"></div>
                                                         ...
                                                         <div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                ...
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="aissuedate<?php echo $i+1; ?>" />
                                                             </div>
                                                        </div><div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                        <label>Expiry date</label>
                                                                ...
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="aexpirydate<?php echo $i+1; ?>" />
                                                             </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-2 age col-md-2 col-xs-3">
                                                                        <label>Age</label>
                                                            <input required maxlength="2" type="text" class="form-control" placeholder="Age" name="cage<?php echo $i+1; ?>"></div>
                                                          ...
                                                          <div class="row"> 
                                                                <div class="col-lg-2 col-md-2 col-xs-2 padding-0">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>Visa Type</label>
                                                            <select class="form-control"name="cvisatype<?php echo $i+1; ?>">
                                                          ...
                                                          <div class="col-lg-2 col-md-2 col-xs-5">
                                                                        <label>Passport No</label>
                                                            <input required type="text" class="form-control" placeholder="Passport No" name="cpassportno<?php echo $i+1; ?>"></div>
                                                            <div class="col-lg-2 col-md-2 col-xs-5">
                                                                        <label>Issue place</label>
                                                            <input required type="text" class="form-control" placeholder="Issue place" name="cissueplace<?php echo $i+1; ?>"></div>
                                                         ...
                                                         <div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                ...
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="cissuedate<?php echo $i+1; ?>" />
                                                             </div>
                                                        </div><div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                        <label>Expiry date</label>
                                                                ...
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="cexpirydate<?php echo $i+1; ?>" />
                                                             </div>
                                                        </div>
                                                       ...
                                                       <div class="row">
                                                            ...
                                                            <div class="col-lg-1 col-md-1 col-xs-2 padding-0">
                                                                    <div class="form-group">
                                                                        <label>Title <?php echo $i+1; ?></label>
                                                        ...
                                                        <div class="col-lg-2 age col-md-2 col-xs-3">
                                                                        <label>Age</label>
                                                            <input required maxlength="2" type="text" class="form-control" placeholder="Age" name="iage<?php echo $i+1; ?>"></div>
                                                          ...
                                                          <div class="row"> 
                                                                <div class="col-lg-2 col-md-2 col-xs-2 padding-0">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>Visa Type</label>
                                                            <select class="form-control"name="ivisatype<?php echo $i+1; ?>">
                                                          ...
                                                          <div class="col-lg-2 col-md-2 col-xs-5">
                                                                        <label>Passport No</label>
                                                            <input required type="text" class="form-control" placeholder="Passport No" name="ipassportno<?php echo $i+1; ?>"></div>
                                                            <div class="col-lg-2 col-md-2 col-xs-5">
                                                                        <label>Issue place</label>
                                                            <input required type="text" class="form-control" placeholder="Issue place" name="iissueplace<?php echo $i+1; ?>"></div>
                                                         ...
                                                         <div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                ...
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="iissuedate<?php echo $i+1; ?>" />
                                                             </div>
                                                        </div><div class="col-md-3 col-lg-3 col-xs-6">
                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                        <label>Expiry date</label>
                                                                ...
                                                                <input required class="date-pick   form-control"  data-date-format="dd-mm-yyyy" type="text" name="iexpirydate<?php echo $i+1; ?>" />
                                                             </div>
                                                        </div>
                                                     ...
                                                     <p>Your booking details will be send to this email address and phone number</p>
                                                      <div class="border-thin m-t-15"></div>
                                                       <label>
